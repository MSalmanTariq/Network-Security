...
public class SdesDecipher {
    ...
    public static void main(String[] args) {
        System.out.println("S-DES Cipher [Decryption]");
           SdesDecipher s1 = new SdesDecipher();
        Scanner in = new Scanner(System.in);

        System.out.println("Enter the Ciphered text");
        String plainTextStr = in.nextLine();
        char[] cipherText = plainTextStr.toCharArray();
        ...
        //E.P xor Key1 (K1)
        char[] EP1_k1_xor = s1.xor(EP1, p8_k2, 8);
        ...
        //E.P xor Key1 (K1)
        char[] EP2_k2_xor = s1.xor(EP2, p8_k1, 8);
        ...
        char[] plainText = s1.ip_inverse(ans3);
